...
const seedCareerPrograms = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield mongoose_1.default.connect(env_1.env.MONGO_URI);
        console.log('Connected to MongoDB');
        yield careerProgram_model_1.default.deleteMany({
            slug: { $in: careerPrograms.map((program) => program.slug) },
        });
        console.log('Cleared existing career programs');
        yield careerProgram_model_1.default.insertMany(careerPrograms);
