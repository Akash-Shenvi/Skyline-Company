...
const careerProgramUpload_1 = require("../config/careerProgramUpload");
...
router.post('/admin', auth_middleware_1.protect, auth_middleware_1.isAdmin, careerProgramUpload_1.careerProgramUpload.fields([
    { name: 'heroImage', maxCount: 1 },
    { name: 'cardImage', maxCount: 1 },
]), careerProgram_controller_1.createCareerProgram);
router.put('/admin/:id', auth_middleware_1.protect, auth_middleware_1.isAdmin, careerProgramUpload_1.careerProgramUpload.fields([
    { name: 'heroImage', maxCount: 1 },
    { name: 'cardImage', maxCount: 1 },
]), careerProgram_controller_1.updateCareerProgram);
