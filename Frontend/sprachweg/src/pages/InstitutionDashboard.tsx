...
const InstitutionDashboard: React.FC = () => {
 ...
 <section className="rounded-[2rem] bg-brand-black p-8 text-white shadow-2xl sm:p-10">
 ...
 <p className="mt-4 max-w-3xl text-base leading-7 text-brand-off-white">
 ...
 <Button
 type="button"
 className="rounded-2xl border border-brand-surface bg-brand-surface/10 px-5 py-3 text-brand-white hover:bg-brand-surface/20 transition-colors"
 ...
 {loading ? (
 <div className="rounded-[2rem] border border-brand-surface bg-brand-white p-10 shadow-sm">
 <div className="mx-auto h-12 w-12 animate-spin rounded-full border-4 border-brand-gold border-t-transparent" />
 </div>
 ) : dashboardData ? (
 <div className="grid gap-8 xl:grid-cols-[0.9fr_1.1fr]">
 <div className="space-y-8">
 <section className="rounded-[2rem] border border-brand-surface bg-brand-white p-8 shadow-sm">
 <div className="flex items-start justify-between gap-4">
 <div>
 <p className="text-sm font-semibold uppercase tracking-[0.3em] text-brand-gold">Institution Profile</p>
 <h2 className="mt-3 text-2xl font-bold text-brand-black">
 ...
 <div className="mt-6 space-y-3 text-sm text-brand-olive-dark">
 ...
 <section className="rounded-[2rem] border border-brand-surface bg-brand-white p-8 shadow-sm">
 <p className="text-sm font-semibold uppercase tracking-[0.3em] text-brand-gold">Request Settings</p>
 <div className="mt-6 grid gap-4">
 <div className="rounded-2xl bg-[#f8f5ec] p-4">
 <div className="flex items-center gap-3">
 <Globe2 className="h-5 w-5 text-brand-gold" />
 <div>
 <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-olive">Language</p>
 <p className="mt-1 text-base font-semibold text-brand-black">{dashboardData.language}</p>
 </div>
 </div>
 </div>

 <div className="rounded-2xl bg-[#f8f5ec] p-4">
 <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-olive">Course</p>
 ...
 <span className="mb-2 block text-sm font-semibold text-brand-black">German Level</span>
 <select
 ...
 <div>
 <p className="text-sm font-semibold uppercase tracking-[0.3em] text-brand-gold">New Submission</p>
 <h2 className="mt-3 text-2xl font-bold text-brand-black">Add students for one German level</h2>
 </div>
 <Button
 type="button"
 variant="outline"
 className="rounded-2xl border-brand-gold text-brand-gold"
 ...
 <div className="mt-4 rounded-2xl border border-brand-gold/20 bg-brand-gold/10 px-4 py-3 text-sm text-brand-olive-dark">
 ...
 <div>
 <p className="text-sm font-semibold uppercase tracking-[0.3em] text-brand-gold">Submission History</p>
 <h2 className="mt-3 text-2xl font-bold text-brand-black">Track request status</h2>
 </div>
 <div className="rounded-2xl bg-brand-gold/10 px-4 py-2 text-sm font-semibold text-brand-gold">
 ...
 <div className="rounded-2xl border border-dashed border-gray-200 px-4 py-8 text-center text-sm text-brand-olive">
 ...
 <div className="mt-4 flex items-center gap-2 text-sm text-brand-olive-dark">
 ...
 className="rounded-full bg-white px-3 py-1 text-xs font-medium text-brand-black ring-1 ring-brand-surface"
 >
