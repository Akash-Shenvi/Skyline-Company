            ...
            <main id="main" role="main" className="min-h-screen pt-20 flex">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            <h1 className="text-5xl lg:text-7xl font-sans font-bold leading-[1.1] mb-8 tracking-tight">
                                Welcome Back to<br />
                                Your <span className="text-brand-red">Skill</span><br />
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                    <div className="w-full max-w-md">
                        ...
                        >
                            <div className="mb-8">
                                <h2 className="font-sans text-3xl font-bold text-brand-black mb-2">Sign In</h2>
                                <p className="text-brand-olive">Enter your credentials to access your account</p>
                            </div>
                            ...
                            <form onSubmit={handleLogin} className="space-y-5">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                        <label className="block text-sm font-semibold text-brand-olive-dark">
                                            Password
                                        </label>
                                    </div>
                                    <div className="relative group">
