...
import { motion, useReducedMotion, useScroll, useTransform, useInView, type Easing } from 'framer-motion';
...
const CareersPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-brand-off-white flex flex-col font-sans text-brand-olive-dark overflow-x-hidden">
            ...
            <section className="relative py-28 sm:py-36 overflow-hidden bg-brand-black text-brand-white border-b-[8px] border-brand-red">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <motion.h1
                            variants={fadeInUp}
                            className="font-sans mb-6 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white"
                        >
            ...
            {/* ── Programs Section ── */}
            <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-12 sm:py-20 sm:px-6 lg:px-8">
                <AnimatedSection className="mb-12 text-center">
                    <motion.h2 variants={fadeInUp} className="text-3xl font-bold text-brand-black">Available programs</motion.h2>
                    <motion.div variants={fadeInUp} className="mx-auto mt-4 h-1 w-20 rounded bg-brand-gold" />
                </AnimatedSection>
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {Array.from({ length: 3 }).map((_, index) => (
                            <div key={index} className="overflow-hidden rounded-[24px] border border-brand-surface bg-white shadow-sm">
                                <div className="h-56 animate-pulse bg-brand-surface/60" />
                                <div className="p-6">
                            ...
                            {programs.map((program) => {
                                ...
                                return (
                                    <motion.article
                                        ...
                                        className="group flex flex-col overflow-hidden rounded-[28px] border border-brand-surface bg-white shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-shadow duration-300 hover:border-brand-gold/40 hover:shadow-[0_12px_40px_-12px_rgba(232,160,32,0.25)]"
                                    >
                                        {/* Card Image */}
                                        ...
                                        <div className="flex flex-1 flex-col p-6">
                                            <p className="text-sm leading-relaxed text-brand-olive-dark min-h-[3rem]">
                                            ...
                                            <div className="mt-auto pt-6">
                                                <Link
                                                    ...
                                                    className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-brand-red px-5 py-3.5 text-sm font-bold text-white transition-colors hover:bg-brand-red-hover focus-visible:ring-2 focus-visible:ring-brand-gold"
                                                >
                                                    Explore program
